...
// Apply skin tone to all 16 faces
document.getElementById("generateBtn").onclick = () => {
  ...
  for (let i = 0; i < data.length; i += 4) {
    ...
    // FACE AREAS = light / beige colours
    if (r > 200 && g > 180 && b > 160) {  // detect skin/light region
      data[i]     = skinColor[0];
    ...
    // everything else (hair, shirt, outline) stay same
  }
